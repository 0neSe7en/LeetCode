...
function toInt(strArr) {
  return parseInt(strArr);
}

require('./localTest')(myAtoi, [
  {expect: 42, args: ['42']},
  {expect: 42, args: ['    42']},
  {expect: 4193, args: ['4193 with words']},
  {expect: 0, args: ['words and 987']},
  {expect: -2147483648, args: ['-91283472332']},
])
